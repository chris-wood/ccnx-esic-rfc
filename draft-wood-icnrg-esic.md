...
Chunk numbers are limited to 8 bytes and do not wrap around.  When the consumer gets near the
...
The producer will only send PacketType ContentObject back to the consumer.  The Inner packet
